...
//        startActivity(intent);
        ...
        Log.i("1 : ", equalizer.getBandLevel((short)0) + " " + equalizer.getBandLevel((short)1) + " " +
                equalizer.getBandLevel((short)2) + " " + equalizer.getBandLevel((short)3) + " " + equalizer.getBandLevel((short)4));
        ...
        eqInfo1 = (TextView)v.findViewById(R.id.eqInfo1);
        eqInfo2 = (TextView)v.findViewById(R.id.eqInfo2);
        eqInfo3 = (TextView)v.findViewById(R.id.eqInfo3);
        eqInfo4 = (TextView)v.findViewById(R.id.eqInfo4);
        eqInfo5 = (TextView)v.findViewById(R.id.eqInfo5);
